        ...
        <div class="main">
            <div class="list">
                <ul>
                    <li>
                        <h1 class="title">
                            <a href="/blog/index.php/Home/Active/article/id/<?php echo ($vo["id"]); ?>"><?php echo ($actives["bk_title"]); ?></a>
                        </h1>
                        <div class="info">
                            <span><?php echo ($actives["time"]); ?></span>
                            <!--<?php echo (date( "Y-m-d" , $vo["time "])); ?>-->
                        </div>
                        <div class="thumb">

                            <!--文章内容-->
                            <?php echo ($vo["bk_content"]); ?>
                            <?php echo htmlspecialchars_decode($actives['bk_content']);?>
                        </div>
                    </li>
                </ul>
            </div>
