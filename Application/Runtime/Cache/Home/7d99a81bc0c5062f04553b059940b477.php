        ...
        <div class="main">
            <div class="list">
                <ul>
                    <li>
                        <h1 class="title">
                            <a href="/blog/index.php/Home/Index/article/id/<?php echo ($vo["id"]); ?>"><?php echo ($msgs["bk_title"]); ?></a>
                        </h1>
                        <div class="info">
                            <span><?php echo ($msgs["time"]); ?></span>
                        ...
                        <div class="thumb">
                            ...
                            <?php echo htmlspecialchars_decode($msgs['bk_content']);?>
                        </div>
                    </li>
                </ul>
            </div>
