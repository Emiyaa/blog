    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blog/index.php/Admin/Index">首页</a><span
                    ...
                    class="crumb-step">&gt;</span><span>新增博文</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blog/index.php/Admin/Active/insert" method="post" id="myform" name="myform"
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="bk_title" size="50" value=""
                                       type="text">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input name="bk_pic" id="" type="file"></td>
                        </tr>
                        <tr>
                            <th>内容：</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="radio" name="recommend" value='0' checked="checked"/>不推荐
                            </td>
                        </tr>
                        <tr>
                            <th></th>
