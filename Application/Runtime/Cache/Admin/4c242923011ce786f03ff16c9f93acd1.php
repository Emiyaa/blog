    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/blog/index.php/Admin/Hpage/add" method="post">
        ...
        <div class="result-wrap">
            <form action="/blog/index.php/Admin/Hpage/del" id="delList" method="get">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blog/index.php/Admin/Hpage/insert"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a class="link-update" href="/blog/index.php/Admin/Hpage/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                    <a class="link-del" href="/blog/index.php/Admin/Hpage/del/id/<?php echo ($vo["id"]); ?>"
                                       onclick="return confirm('您确定要删除 <?php echo ($vo["bk_title"]); ?> 文章吗？');">删除</a>
                                </td>
