...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form action="/blog/index.php/Admin/Cate/del" id="delList" method="get">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td title="column"><a target="_blank" href="#" title="column"><?php echo ($vo["column"]); ?></a></td>
                                ...
                                <td>
                                    ...
                                    <a class="link-del" href="/blog/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>"
                                       onclick="return confirm('您确定要删除 <?php echo ($vo["column"]); ?> 栏目吗？');">删除</a>
                                </td>
