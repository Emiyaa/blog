    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blog/index.php/Admin/Index">首页</a><span
                    class="crumb-step">&gt;</span><a class="crumb-name" href="/blog/index.php/Admin/Active/lists">博文管理</a><span
                    class="crumb-step">&gt;</span><span>修改博文</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blog/index.php/Admin/Active/edit" method="post" id="myform" name="myform"
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="bk_title" size="50"
                                       value="<?php echo ($m["bk_title"]); ?>"
                                       type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>作者：</th>
                            <td><input class="common-text" name="bk_author" size="50" value="<?php echo ($m["bk_author"]); ?>"
                                       type="text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>是否推荐：</th>
                            <td>
                                <?php if($m['recommend'] != '0'): ?><input type="radio" name="recommend" value="1" checked="checked"/>推荐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="recommend" value="0"/>不推荐
                                    <?php else: ?>
                                    <input type="radio" name="recommend" value="1"/>推荐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="recommend" value="0" checked="checked"/>不推荐<?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="bk_pic" id="" type="file"/>
