    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blog/index.php/Admin/Index">首页</a><span
                    class="crumb-step">&gt;</span><a class="crumb-name" href="/blog/index.php/Admin/Cate/lists">栏目管理</a><span
                    class="crumb-step">&gt;</span><span>新增栏目</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blog/index.php/Admin/Cate/insert" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="column" name="column" size="50" value=""
                                       type="text">
                            </td>
                        </tr>
                        <!--<tr>-->
                            <!--<th>作者：</th>-->
                            <!--<td><input class="common-text" name="bk_author" size="50" value="" type="text"></td>-->
                        <!--</tr>-->
                        <!--&lt;!&ndash;<tr>&ndash;&gt;-->
                        <!--&lt;!&ndash;<th><i class="require-red">*</i>缩略图：</th>&ndash;&gt;-->
                        <!--&lt;!&ndash;<td><input name="bk_pic" id="" type="file">&ndash;&gt;-->
                        <!--&lt;!&ndash;&lt;!&ndash;<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>&ndash;&gt;&ndash;&gt;-->
                        <!--&lt;!&ndash;</td>&ndash;&gt;-->
                        <!--&lt;!&ndash;</tr>&ndash;&gt;-->
                        <!--<tr>-->
                            <!--<th>内容：</th>-->
